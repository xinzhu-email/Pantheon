...
class new_layout:
    def __init__(self):
        ...
        sc_pp_step0 = Button(label='Step0: Show gene percentage')
        ...
        sc_pp_step1 = Button(label='Step1: Basic filter of genes and cells')
        sc_pp_step1.on_click(lambda: basic_filter_callback(input1, input2))
        sc_pp_step2 = Button(label='Step2: Show violin plot of quality measures and scatter of total counts')
        ...
        sc_pp_step3 = Button(label='Step3: Filter cells with counts and mitochondrial, and total normalization and logarithmize')
        ...
        sc_pp_step4 = Button(label='Step4: Indentify highly variable genes')
        ...
        sc_cluster_step1 = Button(label='Step1: PCA')
        ...
        sc_cluster_step2 = Button(label='Step2: Clustering with Neighborhood Graph')
        ...
        de_analysis = Button(label='Find marker of these clusters')
        ...
        try:
            homo1_selection = Select(title='Homo-celltype1:', options=cluster_list, value=cluster_list[0])
            homo2_selection = Select(title='Homo-celltype2:', options=cluster_list, value=cluster_list[1])
            hetero_selection = Select(title='Hetero-doublet:', options=cluster_list, value=cluster_list[2])
...
def mitochondrial_genes():
    ...
    figure1 = sc.pl.violin(adata, ['n_genes_by_counts', 'total_counts', 'pct_counts_mt'], jitter=0.4, show=False)
    ...
    figure1.get_figure().savefig(buf1, format="png")
